    ...
    <body>
    	...
    	<div class="login col-md-4">
    		...
    		<form action="userLogin" method="post">
				...
				<div>
					 &nbsp;&nbsp;&nbsp;账号类型：
					 <input type="radio" id="rdoAdmin" name="usertype" value="1">
					 <label for="rdoAdmin">管理员</label> &nbsp;&nbsp;&nbsp;
					 <input type="radio" id="rdoJudge" name="usertype" value="2"  checked>
					 <label for="rdoJudge">评委</label>
				</div>
                  
				<div>
					<input class="btn" type="submit" onclick="return check();"  value="登录"><br />
					<a class="resetPwd" href="resetPassword.jsp" >忘记密码？</a>
				</div>
    		</form>
    	</div>
    	</div>
